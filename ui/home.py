...
def makeUI(weatherData):

    # Extracing Weather Data required to build an image
    weatherInfo = (weatherData['wtype'])
    ...
    # make weather update show here
    wean = tkinter.Label(text=" " + str(weatherInfo).title(), font=("Courier", 28, 'bold'))
    ...
    # this new image is 3x the original
    ...
    # these are the checks to figure out which images should be used.
    if weatherid == '200':
